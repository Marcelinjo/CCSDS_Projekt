...
REM
REM Generated by Vivado on Thu Jun 12 22:59:21 +0200 2025
...
echo "xvhdl --incr --relax -prj TM_GEN_TestDriver_tb_vhdl.prj"
call xvhdl  --incr --relax -prj TM_GEN_TestDriver_tb_vhdl.prj -log xvhdl.log
