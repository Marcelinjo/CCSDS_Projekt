...
REM
REM Generated by Vivado on Wed Jun 11 23:19:37 +0200 2025
...
echo "xvhdl --incr --relax -prj tb_FIFO_Stack_vhdl.prj"
call xvhdl  --incr --relax -prj tb_FIFO_Stack_vhdl.prj -log xvhdl.log
