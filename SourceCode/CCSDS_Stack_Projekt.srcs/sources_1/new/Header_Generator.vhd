...
architecture Behavioral of HeaderGenerator is
    ...
    signal OCF_Flag: STD_LOGIC := '0';                                                              -- OCF not present, thus '0'
    ...
    signal Transfer_Frame_Secondary_Header_Flag: STD_LOGIC := '0';                                  -- Secondary Header is not present, thus Flag shall be 0 according to CCSDS 132.0-B-3 Chapter 4.1.2.7.2 
